...
const Dashboard = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row w-full h-full overflow-hidden bg-transparent">
      {/* LEFT: Habits + Tasks */}
      <aside className="lg:shrink-0 h-full w-full lg:w-[350px] border-r border-zinc-100 dark:border-zinc-900/50 flex flex-col overflow-hidden">
        {/* TAB HEADER */}
      ...
      <main className="flex-1 overflow-y-auto w-full h-full p-8 lg:p-12">
