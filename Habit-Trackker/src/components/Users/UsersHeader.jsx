...
export default function UsersHeader({ search, onSearch }) {
  return (
    <section className="relative overflow-hidden rounded-[2rem] border border-zinc-200 bg-zinc-50 px-6 py-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
        ...
        <div className="flex w-full flex-col gap-3 sm:max-w-sm">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="
                w-full rounded-xl border border-zinc-300 bg-white py-3 pl-10 pr-4 text-sm
